...
import { qtext, metaai } from "../lib/quoted.js";
import x from "../cmd/handler.js";
import { makeStickerFromUrl } from "../lib/events/_sticker.js";
        ...
        m.chat,
        {
          ...
          contextInfo: {
            externalAdReply: {
              ...
              body: `about me ambatukam`,
              thumbnail: fs.readFileSync("./settings/image/image.jpg"),
              sourceUrl: "https://t.me/zaxsql"
            }
          }
        },
        { quoted: m }
